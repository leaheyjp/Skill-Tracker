...
<body>
<?php
#need to find a way to generate session IDs
//session_id(123);
//session_start();
...
// form with input boxes for email/password
?>
    ...
    <ul id="menu">
        ...
        <form action = "Session_Start.php" method="post">
            <table>
                <tr>
                    <td align="right">Student/Professor Email:</td>
            ...
            <input type="submit" style="background-color: seagreen; width: 320px;border-color: #333333" />
        </form>
        </div>
