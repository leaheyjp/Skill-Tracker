...
$sql = "INSERT INTO Centre_Students VALUES('" . $_POST['Student_ID'] . "','". $_POST["first_name"]."','".$_POST["last_name"]."','".$_POST["year"] . "','"
    . $_POST["email"]. "','" . $_POST["password"] . "');";
$sql2 = "INSERT INTO Student_Classes VALUES('" . $_POST['Student_ID'] . "'," . $_POST['class'] . ")";
if ($query = mysqli_query($con,$sql) AND $query2 = mysqli_query($con,$sql2)){
    echo "<h2> User Successfully added</h2>";
    echo "<h3>Return to Login</h3>";
    echo '<form action="Instructor_Profile.php" method="post">';
    echo '<input type="submit" value="Return">';
    echo '</form>';
}
else {
    echo "<h2>New User entry failed. Return to New User</h2>";
